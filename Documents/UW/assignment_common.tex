...
% For logic/type theory's natural deduction proofs.
% See the following for a guide on usage:
...
% Define a new environment for landscape pages in between normal documents
%   (or portrait pages in between landscape documents)
\newenvironment{rotatedpage}
{%
  % Begin environment: swap width and height
  \newpage
...
{%
  % End environment: restore normal page dimensions
  \endgroup
  \newpage
  \paperwidth=\pdfpageheight
  \paperheight=\pdfpagewidth
